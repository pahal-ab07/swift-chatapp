    ...
    <section className="py-16 bg-dark">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {/* Feature Card 1 */}
          <div className="bg-primary rounded-xl p-8 flex flex-col items-center text-center shadow-lg">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-primarySecond">
              {/* SVG icon */}
